    ...
    <div class="login_box">
      ...
      <el-form ref="LoginFormRef" :model="loginVo" label-width="0"  class="login_form">
        <el-form-item prop="username">
          <!-- 用户名-->
          <el-input v-model="registerVo.studentId" prefix-icon="el-icon-user"></el-input>
        </el-form-item>
        <!-- 密码-->
        <el-form-item prop="password">
          <el-input v-model="registerVo.password" prefix-icon="el-icon-lock" type="password"></el-input>
        </el-form-item>
        <el-form-item prop="name">
          <el-input  v-model="registerVo.name" placeholder="Name" ></el-input>
        </el-form-item>
        <el-form-item prop="country">
          <el-input  v-model="registerVo.country" placeholder="Country" ></el-input>
        </el-form-item>
...
export default {
  ...
  methods:{
    ...
    async register(){
      await axios.post("http://localhost:8080/user/register",this.registerVo).then(res=>{
        if(res.data["success"]==true){
          this.$router.push("/")
        }
        // localStorage.setItem("userInfo",JSON.stringify(this.student))
        // if(!localStorage.getItem(this.student.studentId+"invite")){
        ...
        // }
        // if(!localStorage.getItem(this.student.studentId+"message")){
